...
public class AttendanceGroupService {
     ...
     */
    @Transactional
    public AttendanceGroup save(AttendanceGroup attendanceGroup, Set<String> leaderIds){
     ...
     */
    @Transactional
    public AttendanceGroup update(AttendanceGroup attendanceGroup, Set<String> leaderIds) {
